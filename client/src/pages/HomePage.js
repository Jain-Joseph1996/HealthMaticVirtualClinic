                    ...
                    <div className="container py-5">
                        <div className="row mb-5">
                            <div className="col-md-8 col-xl-6 text-center mx-auto">
                                ...
                                <h2 className="fw-bold">News and Announcements</h2>
                                <p className="text-muted">Refer the latest news and announcement here.&nbsp;</p>
                            </div>
                        </div>
                            ...
                            <div className="col mb-4">
                                <div className="d-flex flex-column align-items-center align-items-sm-start">
                                    <p className="bg-light border rounded border-light p-4">
                                        <h2 style={{ color: 'rgb(68, 114, 196)' }}>{item.title}</h2><br />
                                        <span style={{ color: 'rgb(68, 114, 196)' }} dangerouslySetInnerHTML={{ __html: item.content }}></span><br />
                                        </p>
                                </div>
                            </div>
                        ))}
